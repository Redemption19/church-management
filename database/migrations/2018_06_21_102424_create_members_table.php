    ...
    public function up()
{
    Schema::create('members', function (Blueprint $table) {
        ...
        $table->enum('education_level', ['Higher Education', 'Tertiary', 'Senior Secondary', 'Junior Secondary', 'Primary', 'Masters', 'No Education'])->nullable()->default('No Education');
        $table->enum('holy_ghost_baptism', ['yes', 'no'])->default('no');
        $table->enum('water_baptism', ['yes', 'no'])->default('no');
        $table->timestamps();
    });
