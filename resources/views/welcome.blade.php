    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <b><h3 class="text-primary font-weight-bold">Generations of Holy Victorious and</h3></b>
                <b><h3 class="text-primary font-weight-bold">Fulfiiled People in Christ</h3></b>
              </div>
              </div>
              <div class="panel-footer">
                <div class="content">
