...
<head>
	...
	Route::currentRouteName() == 'calendar' || Route::currentRouteName() == ('ticket'))
	...
	@if (Route::currentRouteName() == 'member.register.form' || Route::currentRouteName() == 'attendance.view.form' ||
	Route::currentRouteName() == 'collection.offering' || Route::currentRouteName() == 'attendance')
	<link href="{{ URL::asset('css/sweetalert.css') }}" rel="stylesheet">
	@endif

	<!--Morris.js [ OPTIONAL ]-->
	@if (Route::currentRouteName() == 'member.profile' || Route::currentRouteName() == 'attendance.analysis' ||
	Route::currentRouteName() == 'collection.analysis')
...
<body>
				...
				<div id="mainnav">
					...
					<div id="mainnav-menu-wrap">
							...
							<div class="nano-content">
								...
								<div id="mainnav-profile" class="mainnav-profile">
									<div class="profile-wrap text-center">
										<div class="pad-btm">
											<img class="img-circle img-md" src="{{URL::asset('images/logo.png')}}"
												alt="Profile Picture">
										</div>
										<a href="dashboardprofile-nav" class="box-block" data-toggle="collapse"
											aria-expanded="false">
								...
								<ul id="mainnav-menu" class="list-group">
									...
									<!--Menu list item-->
									<li
										class="{{ Route::currentRouteName() === 'dashboard' ? 'active-sub active' : '' }}">
						...
						{{Route::currentRouteName() === 'member.profile' ? 'active-sub' : ''}}">
										...
										<ul class="collapse">
											<li
												class="{{ Route::currentRouteName() === 'members.all' ? 'active-sub active' : '' }}">
												<a href="{{ route('members.all') }}"><i class="fa fa-list"></i> All
													Members</a>
											</li>
											<li
												class="{{ Route::currentRouteName() === 'member.register.form' ? 'active-sub active' : '' }}">
												<a href="{{route('member.register.form')}}"><i
									...
									{{Route::currentRouteName() === 'attendance' ? 'active-sub active' : ''}}">
										...
										<ul class="collapse">
											<li
												class="{{ Route::currentRouteName() === 'attendance' ? 'active-sub active' : '' }}">
												<a href="{{route('attendance')}}"><i class="fa fa-save"></i> Mark
													Attendance</a>
											</li>
											<li
												class="{{ Route::currentRouteName() === 'attendance.view.form' ? 'active-sub active' : '' }}">
												<a href="{{route('attendance.view.form')}}"><i class="fa fa-eye"></i>
													View Attendance</a>
											</li>
											<li
												class="{{ Route::currentRouteName() === 'attendance.analysis' ? 'active-sub active' : '' }}">
												<a href="{{route('attendance.analysis')}}"><i class="fa fa-signal"></i>
													Analysis</a>
											</li>
										</ul>
									</li>
									<!--Menu list item-->
									<li
										class="{{ (Route::currentRouteName() === 'collection.offering' || Route::currentRouteName() === 'collection.report' || Route::currentRouteName() === 'collection.analysis') ? 'active-sub active' : ''}}">
										<a href="#">
										...
										<ul class="collapse">
											<li
												class="{{Route::currentRouteName() === 'collection.offering' ? 'active-sub active' : '' }}">
												<a href="{{route('collection.offering')}}"><i class="fa fa-save"></i>
													Contribution</a>
											</li>
											<li
												class="{{ Route::currentRouteName() === 'collection.report' ? 'active-sub active' : '' }}">
												<a href="{{route('collection.report')}}"><i class="fa fa-eye"></i>
													Contribution</a>
											</li>
											<li
												class="{{ Route::currentRouteName() === 'collection.analysis' ? 'active-sub active' : '' }}">
												<a href="{{route('collection.analysis')}}"><i class="fa fa-signal"></i>
													Analysis</a>
											</li>
									...
									<li
										class="{{Route::currentRouteName() === 'groups' || Route::currentRouteName() === 'group.view' ? 'active-sub' : ''}}">
										<a href="{{ route('groups') }}">
											<i class="fa fa-users"></i>
									...
									<li
										class="{{Route::currentRouteName() === 'email' || Route::currentRouteName() === 'sms' || Route::currentRouteName() === 'inbox' ? 'active-sub active' : ''}}">
										<a href="#">
										...
										<ul class="collapse">
											<li
												class="{{Route::currentRouteName() === 'email' ? 'active-sub active' : ''}}">
												<a href="{{route('email')}}"><i class="fa fa-envelope"></i> Email</a>
											</li>
											<li
												class="{{Route::currentRouteName() === 'sms' ? 'active-sub active' : ''}}">
												<a href="{{route('sms')}}"><i class="fa fa-mobile"></i> Bulk SMS</a>
											</li>
											<li
												class="{{Route::currentRouteName() === 'inbox' ? 'active-sub active' : ''}}">
												<a href="{{route('inbox')}}"><i class="fa fa-comments"></i>
													Communicator</a>
											</li>
									...
									<li
										...
										<ul class="collapse">
											@if (\Auth::user()->isAdmin())
											<li
												class="{{Route::currentRouteName() === 'branches' ? 'active-sub' : ''}}">
												<a href="{{route('branches')}}"><i class="fa fa-tree"></i> Branches</a>
											</li>
											<li
												class="{{Route::currentRouteName() === 'branch.register' ? 'active-sub' : ''}}">
												<a href="{{route('branch.register')}}"><i class="fa fa-plus"></i> Add
													New Branch</a>
											</li>
											<li
												class="{{Route::currentRouteName() === 'branch.tools' ? 'active-sub' : ''}}">
												<a href="{{route('branch.tools')}}"><i class="fa fa-wrench"></i>
													Tools</a>
											</li>
											@endif
											<li
									...
									<li
										class="{{Route::currentRouteName() == 'report.membership.all' || Route::currentRouteName() == 'report.membership' || Route::currentRouteName() == 'report.collections' || Route::currentRouteName() == 'report.collections.all' || Route::currentRouteName() == 'report.attendance' || Route::currentRouteName() == 'report.attendance.all' ? 'active-sub active' : ''}}">
										<a href="#">
										...
										<ul class="collapse">
											@if(!(\Auth::user()->isAdmin()))
											<li
												class="{{ Route::currentRouteName() === 'report.membership' ? 'active-sub active' : '' }}">
												<a href="{{route('report.membership')}}">Membership</a>
											</li>
											<li
												class="{{ Route::currentRouteName() === 'report.collections' ? 'active-sub active' : '' }}">
												<a href="{{route('report.collections')}}">Contributions</a>
											</li>
											<li
												class="{{ Route::currentRouteName() === 'report.attendance' ? 'active-sub active' : '' }}">
											...
											<li
												class="{{Route::currentRouteName() == 'report.membership.all' || Route::currentRouteName() == 'report.membership' || Route::currentRouteName() == 'report.collections' || Route::currentRouteName() == 'report.collections.all' || Route::currentRouteName() == 'report.attendance' || Route::currentRouteName() == 'report.attendance.all' ? 'active-sub active' : ''}}">
											<li
												class="{{Route::currentRouteName() == 'report.membership.all' || Route::currentRouteName() === 'report.membership' ? 'active-sub active' : '' }}">
												<a href="#">
													<i class="fa fa-users"></i>
												...
												<ul class="collapse">
													<li
														class="{{ Route::currentRouteName() == 'report.membership.all' ? 'active-sub active' : '' }}">
														<a href="{{route('report.membership.all')}}"><i
																class="fa fa-level-up"></i> All Branches</a>
													</li>
													<li
														class="{{ Route::currentRouteName() == 'report.membership' ? 'active-sub active' : '' }}">
														<a href="{{route('report.membership')}}"><i
																class="fa fa-map-marker"></i> This Branch</a>
													</li>
												</ul>
											</li>
											<li
												class="{{Route::currentRouteName() == 'report.collections' || Route::currentRouteName() == 'report.collections.all' ? 'active-sub active' : '' }}">
												<a href="#">
													<i class="fa fa-money"></i>
													<span class="menu-money">Contributions</span>
													<i class="arrow"></i>
												</a>
												<ul class="collapse">
													<li
														class="{{Route::currentRouteName() == 'report.collections.all' ? 'active-sub active' : '' }}">
														<a href="{{route('report.collections.all')}}"><i
																class="fa fa-level-up"></i> All Branches</a>
													</li>
													<li
														class="{{ Route::currentRouteName() === 'report.collections' ? 'active-sub active' : '' }}">
														<a href="{{route('report.collections')}}"><i
																class="fa fa-map-marker"></i> This Branch</a>
											...
											<li
												class="{{Route::currentRouteName() == 'report.attendance' || Route::currentRouteName() == 'report.attendance.all' ? 'active-sub active' : '' }}">
												<a href="#">
													<i class="fa fa-check"></i>
												...
												<ul class="collapse">
													<li
														class="{{ Route::currentRouteName() == 'report.attendance.all' ? 'active-sub active' : '' }}">
														<a href="{{route('report.attendance.all')}}"><i
																class="fa fa-level-up"></i> All Branches</a>
													</li>
													<li
														class="{{ Route::currentRouteName() == 'report.attendance' ? 'active-sub active' : '' }}">
														<a href="{{route('report.attendance')}}"><i
																class="fa fa-map-marker"></i> This Branch</a>
													</li>
												</ul>
											</li>
	...
	@if (Route::currentRouteName() == 'member.register.form' || Route::currentRouteName() == 'attendance.view.form' ||
	Route::currentRouteName() == 'collection.offering')
	<script src="{{ URL::asset('js/sweetalert.min.js') }}"></script>
	@endif

	@if (Route::currentRouteName() == 'member.register.form' || Route::currentRouteName() == 'attendance.view' ||
	Route::currentRouteName() == 'collection.offering' || Route::currentRouteName() == "members.all")
