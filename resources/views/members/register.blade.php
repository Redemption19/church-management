        ...
        <div id="page-content">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="panel rounded-top" style="background-color: #ffff; width: 120%; margin-left: -10%;">
                        ...
                        <div style="background-color: #ffff; width: 120%; margin-left: -10%;">
                            <div class="" style="border:1pt solid #fff; border-radius:25px;">
                                <!-- BASIC FORM ELEMENTS -->
                                <!--===================================================-->
                                <form id="register-form" method="POST" action="{{ route('member.register') }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <select name="title"
                                                    class="selectpicker col-xs-3 col-sm-4 col-md-4 col-lg-7"
                                        ...
                                        <!--Text Input-->
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-text-input">Middle Name</label>
                                            <div class="col-md-9">
                                                <input type="text" id="demo-text-input" name="middlename"
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="demo-text-input">Education Level</label>
                                            <div class="col-md-9">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group pad-ve"style="margin-left: 70px;">
                                        ...
                                        <div class="form-group pad-ver" style="margin-left: 70px;">
                                        ...
                                        <div class="form-group pad-ve" style="margin-left: 70px;">
                                            <label class="col-md-3 control-label">Water Baptism</label>
                                            <div class="col-md-9" >
                                                <!-- Radio Buttons -->
                                                <div class="radio">
                                                    <input id="water-baptism-yes" class="magic-radio" value="yes" type="radio" name="water_baptism" checked>
                                                    <label for="water-baptism-yes">Yes</label>
                                                    <input id="water-baptism-no" class="magic-radio" value="no" type="radio" name="water_baptism">
                                                    <label for="water-baptism-no">No</label>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="form-group pad-ve" style="margin-left: 70px;">
                                            <label class="col-md-3 control-label">Holy Ghost Baptism</label>
                                            <div class="col-md-9">
                                                <!-- Radio Buttons -->
                                                <div class="radio">
                                                    <input id="holy-ghost-baptism-yes" class="magic-radio" value="yes" type="radio" name="holy_ghost_baptism" checked>
                                                    <label for="holy-ghost-baptism-yes">Yes</label>
                                                    <input id="holy-ghost-baptism-no" class="magic-radio" value="no" type="radio" name="holy_ghost_baptism">
                                                    <label for="holy-ghost-baptism-no">No</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <div class="btn btn-file element">
                                                    <i class="fa fa-3x fa-folder custom-icon-color"></i>
                                                    <span class="name file-input-label">Choose File</span>
                                                    <input id="img-input" type="file" accept="image/*"
                                                        name="photo">
                                                </div>

                                                <div class="btn element" data-toggle="modal" data-target="#myModal">
                                                    <i class="fa fa-camera custom-icon-color"></i><span
                                                        class="name">From Cam</span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <button type="button" data-target="#demo-default-modal"
                                                    ...
                                                    modal</button>
                                                <button id="add-relative-btn" class="btn btn-primary"type="button">Add
                                                    Relative</button>
                                            </div>
                                        </div>
                                        <!--div class="row">
             <div class="col-md-3" style="">
              <button class="btn btn-info pull-center" type="submit">REGISTER MEMBER</button>
                                        ...
                                        <div class="form-group" style="padding-top:50px">
                                            <div class="col-md-9">
                                                <span class=" pull-right">
                                                    <button id="submit" class="btn btn-primary pull-center"
                        ...
                        <div class="panel-footer panel-primary bg-white">
                            <!-- Modal -->
