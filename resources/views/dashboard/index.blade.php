  ...
  <div id="page-content">
    <div class="row" >
     @include('layouts.error')
      <style>
      .img-center {        display: block;        margin-left: auto;        margin-right: auto;        width: 20%;      }
      </style>
    </div>
    ...
    <div class="panel-body">
      <div class="row mar-top">
        ...
        <div class="small-box bg-info">
            ...
            <a href="{{ route('all.blade.php') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
    </div>
        <!--===================================================-->
        ...
        <div class="small-box bg-success">
            <div class="inner">
                <h3 class="church-details">{{$total['members']}}</h3>
                <p>Members</p>
            </div>
            <div class="icon">
        ...
        <div class="small-box bg-warning">
            <div class="inner">
                <h3 class="church-details">{{$total['workers']}}</h3>
                <p>Workers</p>
            </div>
            <div class="icon">
        ...
        <div class="small-box bg-danger">
            <div class="inner">
                <h3 class="church-details">{{$total['pastors']}}</h3>
                <p>Pastors</p>
            </div>
            <div class="icon">
  ...
  <div class="panel">
    <div id="manual-analysis-hd" class="text-center bg-primary">
      ...
      <div class="panel-body">
          <div class="row mar-top">
              <div class="col-md-4">
                  <h3 class="text-main text-normal text-2x mar-no">Giving Statistics</h3>
                  <!-- <h5 class="text-uppercase text-muted text-normal">Report for last 12 Months</h5> -->
                  <div class="row mar-top">
                      <div class="col">
                          <table class="table table-condensed table-trans">
