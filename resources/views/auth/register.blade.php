    ...
    <div id="container" class="cls-container">
        ...
        <div class="cls-content">
            <div class="title m-b-md">
                <h1 class="" style="color: #2d8caf;">Super Admin Registration</h1>
            </div>
            ...
            <div class="cls-content-lg panel">
                <div class="panel-body">
                    <div class="mar-ver pad-btm text-light">
                        <h1 class="h3" style="color: #2d8caf;">Create a New Branch Account</h1>
                        <p>Set up account.</p>
                    </div>
                    @if (isset($_GET['s']))
                    ...
                    <form id="branch-form" action="{{ route('visitor.register') }}" method="POST">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input id="password" type="password" placeholder="Password "
                                        ...
                                        name="password" required style="border-color: #2d8caf;">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <textarea type="text" class="form-control" placeholder="Branch Address" name="address"
                                        style="border-color: #2d8caf;"></textarea>
                    ...
                    <label for="demo-form-checkbox">I agree with the <a href="pages-register.html#" class="btn-link text-bold">Terms and Conditions</a></label>
                        ...
                        <button class="btn btn-lg btn-block" type="submit"
                            style="background-color: #2d8caf; color: white;">Register</button>
                    </form>
                </div>
            </div>
